...
VAR human_num = 24
VAR human_i = 0
({human_i+1}/{human_num})请问您可以接受<b>"{!口|足|肛|手|乳|小玩具|野战|催眠|妹妹|姐姐|灌肠|紧缚|性转|放置|榨乳|监禁|性转|双穴|NTR|药渍|露出|轻度殴打|榨精|人外}"</b>吗？
~human_i++
+ 喜欢
{   human_i <= 17:
         ~point += 1
...
{   point <= 6:
    <h4>绵羊级</h4>
    你对于作品方面的标准仅停留在原始到不能更原始的标准，神知道了精神洁癖的地步，真的是让人叹为观止。
    ->DONE
}
{   point <= 20:
    <h4>人类级</h4>
